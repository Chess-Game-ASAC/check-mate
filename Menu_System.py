...
class MainMenu(Menu):
    def __init__(self, game):
        ...
        self.optionsx, self.optionsy = self.mid_w, self.mid_h +10
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('Check Mate Game', 20, self.game.DISPLAY_W / 2, self.game.DISPLAY_H / 2 -200,"orange")
            self.game.draw_text("Start Game", 20, self.startx, self.starty)
            self.game.draw_text("Rules", 20, self.optionsx, self.optionsy)
    ...
    def move_cursor(self):
        """
        this methode to Move between the options to select the appropriate option using the keyboard:
        DOWN_KEY
        UP_KEY
        """
